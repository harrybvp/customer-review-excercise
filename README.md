...
1. [CustomerReviewService](customerreviewserver.jar.src/de/hybris/platform/customerreview/CustomerReviewService.java) is the interface and [CustomerReviewServiceImpl](customerreviewserver.jar.src/de/hybris/platform/customerreview/CustomerReviewServiceImpl.java) is it's implementation (Refer it's JavaDoc for implementation details)
